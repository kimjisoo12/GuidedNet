...
class BraTS2019(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        h5f = h5py.File(self._base_dir + "/{}/2022.h5".format(image_name), 'r')
        image = h5f['image'][:]
...
class TwoStreamBatchSampler(Sampler):
    ...
    def __init__(self, primary_indices, secondary_indices, batch_size, secondary_batch_size):
        ...
        num_repeat = math.ceil(len(self.secondary_indices) / len(self.primary_indices))
        self.primary_indices = self.primary_indices * num_repeat
        self.primary_indices = random.sample(self.primary_indices, len(self.secondary_indices))
    ...
    def __len__(self):
        #return len( self.primary_indices_new) // self.primary_batch_size
