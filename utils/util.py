...
def label_onehot(inputs, num_segments):
    batch_size, im_z, im_y, im_x = inputs.shape
    outputs = torch.zeros((num_segments, batch_size, im_z, im_y, im_x)).cuda()
    ...
    return outputs.permute(1, 0, 2, 3, 4)
